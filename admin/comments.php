                                   ...
                                   <tr>
                                      ...
                                      <td width="20%"><?php echo $comment->author;  ?>
                                        <div class="action_links">
                                              <a href="delete_comment.php?id=<?php echo $comment->id ; ?>" class="btn btn-danger btn-xs" style="margin-top: 5px;">Delete</a>
                                              <a href="edit_comment.php?id=<?php echo $comment->id ; ?>" class="btn btn-success btn-xs" style="margin-top: 5px;">Edit</a>
                                              <a href="view_comment.php?id=<?php echo $comment->id ; ?>" class="btn btn-info btn-xs" style="margin-top: 5px;">View</a>
                                          </div>
